...
export const SCHEMA = [
  ...
  {
    id: 'track-record',
    file: 'content/track-record.json',
    label: 'Track record',
    icon: '▤',
    preview: 'track-record.html',
    sections: [
      seoSection,
      heroSection(),
      {
        ...
        path: '',
        fields: [
          { key: 'cta', type: 'text', label: 'Texto del hover', help: 'Aparece sobre cada proyecto de las dos galerías.' },
        ],
      },
      {
        id: 'national',
        label: 'Track record nacional',
        path: 'national',
        fields: [
          { key: 'title', type: 'rich', label: 'Titular', rows: 3, help: RICH_HELP },
          { key: 'lead', type: 'rich', label: 'Entradilla', rows: 3, help: RICH_HELP },
      ...
      {
        id: 'international',
        label: 'Track record internacional',
        path: 'international',
        fields: [
          { key: 'title', type: 'rich', label: 'Titular', rows: 2, help: RICH_HELP },
          { key: 'lead', type: 'rich', label: 'Entradilla', rows: 3, help: RICH_HELP },
