<!--
  Este archivo es el README de la PLANTILLA de proyecto seguro corporativa, no
  el de este proyecto. Llegó al repositorio en el commit 58ecfd1 («Add files via
  upload»), donde sobrescribió el README de la web; se ha devuelto el original a
  la raíz y la plantilla se conserva aquí, junto al resto de sus piezas.

  Describe el marco que vive en `security/`. Ojo: habla de «27 controles»
  mientras que `security/policy.yml` define 30 — es la discrepancia R-7 del
